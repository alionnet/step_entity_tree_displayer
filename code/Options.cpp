...
namespace opt {
	std::set<std::string> ssFilteredOutTypes({
		...
		"CLOSED_SHELL", "PROPERTY_DEFINITION_REPRESENTATION"//,"CONTEXT_DEPENDENT_SHAPE_REPRESENTATION"//, "AXIS2_PLACEMENT_3D", "PRODUCT_DEFINITION"
		/*"IFCFACETEDBREP", "IFCOPENSHELL", "IFCFACE", "IFCGEOMETRICREPRESENTATIONCONTEXT", "IFCAXIS2PLACEMENT3D",
		"IFCPOLYLINE", "IFCOWNERHISTORY", "IFCLOCALPLACEMENT", "IFCUNITASSIGNMENT", "IFCRELASSOCIATESMATERIAL", "IFCRELASSIGNSTOGROUP"*/
		});
